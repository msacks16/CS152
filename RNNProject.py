...
def main():
	...
	dataset = numpy.loadtxt('2003 to 2004.csv', delimiter=',', skiprows=1)
	predset = numpy.loadtxt('2005 prediction test.csv', delimiter=',', skiprows=1)
	outcsv = "2005 results.csv"
	pX = predset[:, 0:8]
	...
	model=Sequential()
	model.add(SimpleRNN(return_sequences=False, kernel_initializer='glorot_normal', input_shape=(None, 1), units=64))
